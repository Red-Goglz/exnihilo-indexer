export const positionNftAbi = [
  ...
  { "inputs": [], "name": "PositionNotFromPool", "type": "error" },
  ...
  {
    "inputs": [{ "internalType": "uint256", "name": "tokenId", "type": "uint256" }, { "internalType": "uint256", "name": "newDeadline", "type": "uint256" }],
    "name": "extendDeadline",
    "outputs": [],
    "stateMutability": "nonpayable",
    "type": "function"
    ...
    "outputs": [
      {
        "components": [
          ...
          { "internalType": "address", "name": "lockedToken", "type": "address" },
          { "internalType": "uint256", "name": "lockedAmount", "type": "uint256" },
          { "internalType": "uint256", "name": "usdcIn", "type": "uint256" },
          { "internalType": "uint256", "name": "airUsdMinted", "type": "uint256" },
          { "internalType": "uint256", "name": "airTokenMinted", "type": "uint256" },
  ...
  },
  {
    "inputs": [
      ...
      { "internalType": "address", "name": "pool", "type": "address" },
      { "internalType": "address", "name": "airToken", "type": "address" },
      { "internalType": "uint256", "name": "usdcIn", "type": "uint256" },
      { "internalType": "uint256", "name": "airUsdMinted", "type": "uint256" },
      { "internalType": "uint256", "name": "airTokenLocked", "type": "uint256" },
      { "internalType": "uint256", "name": "feesPaid", "type": "uint256" },
      { "internalType": "uint256", "name": "deadline", "type": "uint256" }
    ],
    "name": "mintLong",
  ...
  },
  {
    "inputs": [
      { "internalType": "address", "name": "to", "type": "address" },
      { "internalType": "address", "name": "pool", "type": "address" },
      { "internalType": "address", "name": "airUsdToken", "type": "address" },
      { "internalType": "uint256", "name": "airTokenMinted", "type": "uint256" },
      { "internalType": "uint256", "name": "airUsdLocked", "type": "uint256" },
      { "internalType": "uint256", "name": "usdcIn", "type": "uint256" },
      { "internalType": "uint256", "name": "feesPaid", "type": "uint256" },
      { "internalType": "uint256", "name": "deadline", "type": "uint256" }
    ],
